...
├── users-script.js        # Управление пользователями
...
- `POST /api/admin/users/:userId/role` - Изменить роль пользователя
...
- **admin** / **Alfred20002** - Главный администратор
...
- Изменение ролей пользователей (Пользователь ↔ Администратор)
- Удаление пользователей (кроме главного администратора)
- Поиск и фильтрация пользователей

### Доступ к функциям
- Управление товарами и статьями
- Просмотр статистики
